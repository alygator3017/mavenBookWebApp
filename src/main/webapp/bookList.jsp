<%-- 
    Document   : bookList
    Created on : Apr 4, 2016, 11:48:21 AM
    Author     : Alyson
--%>
    ...
    <body>
        <div class="wrapper">
            ...
            <div class="row col-lg-12">
                <h1 class="col-lg-5">Book Database</h1>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="<%= response.encodeURL("BookController?action=addNewBook")%>" class="detailsForm">
                                <fieldset>
                                    <legend></legend>
